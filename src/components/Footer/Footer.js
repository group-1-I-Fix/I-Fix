        ...
        <div className="footer-contactUs">
          <div className='footer-contact-info'>
           <h1 className="contatUsTitle">Contact US</h1>
            <p className="contatUsPara"><i class="fas fa-map-marker-alt"></i> Amman/Jordan</p>
            <p className="contatUsPara"><i class="fas fa-phone-alt"></i> +962798861423</p>
            <p className="contatUsPara"><i class="fas fa-envelope"></i> ifix@gmail.com</p>
          </div>
        </div>
        </div>

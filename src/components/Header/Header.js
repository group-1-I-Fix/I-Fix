        ...
        <header className="header-Nav">
            <nav className="Navbar-header">
                ...
                <div className='Navbar-Links-header'>
                    <ul className={`${state? 'toggled-burger-menu' : ''} Navbar-links-list`}>
                        <li >Home</li>
                        <li >Services</li>
                        <li >About us</li>
                    </ul>
                ...
                <div className="Navbar-right-header">
                    <img className="user-profile dropdown-toggle" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" src={avatarURL} alt="user profile" />
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a className="dropdown-item" href="#">Profile</a></li>
                        <li><a className="dropdown-item" href="#">Sign out</a></li>
                    </ul>
                    <p className="burger-menu dropdown-toggle" data-bs-toggle="dropdown" id="dropdownMenuButton1" onClick={toggleMenu}>Menu</p>
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
